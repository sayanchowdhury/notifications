...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(
            PROJECT_ROOT, '..', 'templates').replace('\\', '/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = '/'
ACCOUNT_EMAIL_CONFIRMATION_HMAC = False if DEBUG else True
SOCIALACCOUNT_ADAPTER = 'profiles.adapters.NotificationsSocialAccountAdapter'
